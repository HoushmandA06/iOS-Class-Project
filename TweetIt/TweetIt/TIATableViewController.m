...
-(id)initWithCoder:(NSCoder *)aDecoder   // used for storyboard
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDictionary * tweet = tweets[indexPath.row]; // passing the rows to assign a tweet a row
    
    //NSString * type = tweet[@"type"]; // dont need it now, inserted tweet[@"type"] below
    
    // an array of types for switch
...
//    }
    ...
    if(cell == nil)
    {
        cell = [[UITableViewCell alloc] initWithStyle:style reuseIdentifier:reuseID]; //is doing what we did in storyboard with cell style
    }
