...
class ViewController: UIViewController, AVCaptureAudioDataOutputSampleBufferDelegate {
    ...
    override func viewDidLoad() {
        ...
        audioDataOutput.setSampleBufferDelegate(self, queue:
            dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT,CUnsignedLong()))
    ...
    func createBubble () {
        ...
        var randomSize = Float(arc4random_uniform(40) + 20)
